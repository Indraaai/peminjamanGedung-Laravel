...
<body>
    ...
    <div class="booking-details">
        ...
        <div class="booking-details-content">
            ...
            <div class="detail-row">
                ...
                <div class="detail-value">{{ \Carbon\Carbon::parse($peminjaman->tanggal)->isoFormat('dddd, D MMMM Y') }}
                </div>
            </div>
    ...
    <div class="verification-info">
        ...
        <div class="verification-code">{{ strtoupper(substr(md5($peminjaman->id . $peminjaman->created_at), 0, 8)) }}
        </div>
    </div>
