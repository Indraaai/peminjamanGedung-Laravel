{{--
    File: resources/views/admin/ruangan/index.blade.php

    Deskripsi:
    Tampilan untuk manajemen (CRUD) data ruangan. Didesain ulang dengan
    gaya modern, menampilkan data dalam tabel yang bersih dan responsif.
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row justify-between sm:items-center gap-4 mb-8">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Tambah, edit, atau hapus data ruangan di sini.</p>
                </div>
                        ...
                        <tbody>
                            @forelse ($ruangans as $ruangan)
                                <tr class="bg-white border-b hover:bg-gray-50">
                                    <td class="px-6 py-4">
                                        @if ($ruangan->foto)
                                            <img src="{{ asset('storage/' . $ruangan->foto) }}"
                                                alt="Foto {{ $ruangan->nama }}"
                                                class="h-12 w-16 object-cover rounded-md shadow-sm">
                                        @else
                                            <div
                                                class="h-12 w-16 bg-gray-200 rounded-md flex items-center justify-center">
                                    ...
                                    <td class="px-6 py-4 font-medium text-gray-800">{{ $ruangan->nama }}</td>
                                    <td class="px-6 py-4">{{ $ruangan->gedung->nama }}</td>
